...
from ..utils.modelling_utils import data_generator, get_bucket_by_seq_len, \
        construct_simple_lstm
...
def main(args):
    ...
    checkpoint_path = os.path.join(checkpoints_dir,
            f'batch{batch_size}-steps{steps}-epoch' + \
            '{epoch:02d}.h5')
